<template>
    <div class="bg-white p-4 rounded-md shadow-md w-full max-w-lg mx-auto mt-20 mb-20">
        <h2 class="text-3xl font-bold mb-6 text-blue-600">Create Task</h2>
        <form @submit.prevent="createTask" class="mb-4">
            ...
            <br/>
           <button class="mt-4 p-2 bg-blue-500 text-white rounded-md hover:bg-blue-600" type="submit">Create Task</button>
        </form>
    </div>
</template>
